    ...
    content.innerHTML = `
      ...
      <div class="flex flex-grow items-center justify-center p-4 bg-gradient-to-t from-purple-900 to-blue-900">
              ...
              <form id="login-form" class="space-y-6 auth-form active text-[1.5rem]">
                ...
                <div>
                  ...
                  <label for="totp-password" class="floating-label text-white block">
                    2FA Key <span class='text-blue-300'> (if enabled) </span>
                  </label>
                </div>
                ...
                <div class="grid grid-cols-2 gap-3">
                  ...
                  >
                    <div class="absolute inset-0 bg-gradient-to-br from-blue-500 via-red-500 to-yellow-500 opacity-0 transition-opacity duration-100"></div>
                    <svg class="w-6 h-6 relative z-10 transition-transform duration-100 group-hover:scale-110" viewBox="0 0 24 24">
                  ...
                  <button
                    ...
                    class="oauth-button relative flex items-center justify-center px-4 py-2.5 border border-gray-300 rounded-lg bg-white transition-all duration-100 overflow-hidden group hover:border-gray-400 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 active:shadow-md"
                  >
                    <div class="absolute inset-0 bg-gray-900 opacity-0 transition-opacity duration-100"></div>
                    <svg class="w-6 h-6 relative z-10 transition-all duration-100 group-hover:scale-110 group-hover:text-gray-900" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 pt-20 self-start flex flex-col">
          ...
          <div id="error-display" class="duration-200 hidden bg-red-500 border-2 border-red-300 text-white text-center self-center rounded-lg text-[1.4rem] mt-10 py-4 w-1/2">
