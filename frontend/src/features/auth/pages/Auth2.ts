...
export class AuthPage {
  ...
  private createElement(): HTMLElement {
    ...
    content.innerHTML = `
      ...
      <div class="flex flex-grow items-center justify-center p-4 bg-gradient-to-r from-blue-800 to-red-700">

        <div class="flex-1 flex justify-center items-center">
          <img class='border-2 border-white h-[600px] w-[400px]' src='/src/img/jinx.gif'>
        </div>
        
        <div class="flex flex-grow flex-col items-center justify-center p-6 bg-inherit flex-1">
            ...
            <div id="form-container" class="transition-all duration-100">
              ...
              <form id="login-form" class="space-y-6 auth-form active text-[1.5rem]">
                ...
                <button 
                  type="submit" 
                  id="login-submit"
                  class="premium-button relative w-full py-3 px-4 rounded-lg font-medium overflow-hidden duration-100 bg-blue-700 text-white hover:bg-blue-800 cursor-pointer"
                >
        ...
        <div class="flex-1 pt-20 self-start">
          <div class='text-[2rem] text-white flex flex-col justify-center items-center' id='register-btn'>
            First time ?
            <button
              type="button"
              id="switch-to-register"
              class="hover:scale-110 duration-100 border-2 border-black bg-blue-700 p-4 w-1/2"
            >
              Register here !
            </button>
          </div>

          <div class='text-[2rem] text-white flex-col justify-center items-center hidden' id='login-btn'>
