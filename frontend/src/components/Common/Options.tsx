    ...
    return (
        <div id="options" className='border-2 border-black absolute right-[20px] bottom-[-127px] w-[260px] translate-y-1/2 bg-white hidden text-black'>
            <ul className="text-[1.5rem] divide-y-2 cursor-pointer divide-black indent-2">
                <Link to={"/profile"}><li className="py-2 pl-2 cursor-pointer hover:underline underline-offset-4 flex">
                    Profile 
                ...
                <li className="py-2 pl-2 cursor-pointer hover:underline underline-offset-4 flex" onClick={openFriends}>
                    Friends
                    <span className="flex flex-grow justify-end items-center mr-6"><img src="./src/img/friends.svg" alt="logout" className="h-[27x] w-[27px]"/></span>
                </li>
                <li className="py-2 pl-2 cursor-pointer hover:underline underline-offset-4 flex" onClick={handleLogout}>
                    Log Out
