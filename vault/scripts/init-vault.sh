...
vault kv put secret/oauth \
  ...
  github_redirect_uri="${GITHUB_REDIRECT_URI:-https://localhost:8443/api/auth/github/callback}" \
  google_client_id="${GOOGLE_CLIENT_ID:-your-google-client-id}" \
  google_client_secret="${GOOGLE_CLIENT_SECRET:-your-google-client-secret}" \
  google_redirect_uri="${GOOGLE_REDIRECT_URI:-https://localhost:8443/api/auth/google/callback}"
